...
abstract class WithTwoBrowsers[WEBDRIVER <: WebDriver](
  ...
  lazy val browser1: TestBrowser = TestBrowser.of(webDriver, Some("http://localhost:" + port))
  lazy val browser2: TestBrowser = TestBrowser.of(webDriver, Some("http://localhost:" + port))
